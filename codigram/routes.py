...
@login_required
def home():
    return flask.render_template("home.html", title="DynamiCode - Home")


@app.route("/modules")
@login_required
def modules():
    return flask.render_template("modules/modules.html", title="DynamiCode - Modules")


@app.route("/modules/python-module/<int:module_number>")
def python_module(module_number):
    module_files = [f"modules/python_module0.html", f"modules/python_module1.html", f"modules/python_module2.html"]
